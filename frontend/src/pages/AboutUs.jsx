...
const testimonials = [
  {
    quote: "The AI Strategy Advisor completely transformed how we approach tech investments. It turned a vague idea into a concrete roadmap.",
    author: "Sarah Jenkins",
    role: "CTO, TechInnovate",
    rating: 5,
  },
  {
    quote: "An indispensable tool. We were able to identify $1.2M in potential savings within our first week of using the platform.",
    author: "Marcus Chen",
    role: "Director of Operations, GlobalLogistics",
    rating: 5,
  },
  {
    quote: "It's like having a top-tier consulting firm at your fingertips. The clarity and actionable next steps are unmatched.",
      ...
      <nav className="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-blue-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            ...
            <Link to="/features" className="hover:text-blue-600 transition-colors duration-200">Features</Link>
            <Link to="/dashboard" className="hover:text-blue-600 transition-colors duration-200">Dashboard</Link>
            <Link to="/about" className="text-blue-600 font-semibold transition-colors duration-200">About Us</Link>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                onClick={() => {
                  setHeroBtn("mission");
                  whyFade.ref.current?.scrollIntoView({ behavior: "smooth" });
                }}
                className={`
              ...
              <button
                onClick={() => {
                  setHeroBtn("team");
                  teamFade.ref.current?.scrollIntoView({ behavior: "smooth" });
                }}
                className={`
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-blue-50/50">
              ...
              <p className="text-sm text-gray-600 mb-6 italic">"{t.quote}"</p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-blue-600 font-bold text-sm">
                  {t.author.charAt(0)}
                </div>
                <div>
