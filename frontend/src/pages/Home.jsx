  ...
  return (
    ...
    >
      ...
      <nav className="h-20 flex items-center justify-between px-16 py-10 animate-nav">
        ...
        <ul className="hidden lg:flex gap-10 text-sm font-medium text-gray-600">
          <Link to="/" className="text-indigo-600 font-semibold transition-colors">Home</Link>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-10 hero-buttons">
              ...
              {/* About Us button */}
              <Link to="/about">
                <button className="roi-btn border border-indigo-600 text-indigo-600 bg-white hover:bg-indigo-600 hover:text-white px-8 py-4 rounded-xl transition-all duration-300">
                  About Us
                </button>
              </Link>
